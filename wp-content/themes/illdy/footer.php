...
if ( current_user_can( 'edit_theme_options' ) ) {
	$footer_copyright  = get_theme_mod( 'illdy_footer_copyright', __( '&copy; Copyright 2016. All Rights Reserved.', 'Techno Solution' ) );
} else {
...
<footer id="footer">
	...
	<div class="bottom-footer">
		<div class="container">
			<p class="copyright">
<!--				<span><?php printf( '%s <a href="%s" title="%s" target="_blank">%s</a>.', __( '', 'illdy' ), esc_url( 'http://colorlib.com/wp/themes/illdy' ), __( 'Illdy', 'illdy' ), __( '', 'illdy' ) ); ?></span> -->
